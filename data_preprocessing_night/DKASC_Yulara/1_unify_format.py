...
if __name__ == '__main__':
    ...
    folder_path=os.path.join(project_root, 'data/DKASC_Yulara/uniform_format_data'),
    log_file_path=os.path.join(project_root, 'data_preprocessing_night/DKASC_Yulara/raw_info/raw_data_info.txt')
    )
    plot_correlation_each.plot_feature_vs_active_power(
            data_dir=os.path.join(project_root, 'data/DKASC_Yulara/uniform_format_data'), 
            save_dir=os.path.join(project_root, 'data_preprocessing_night/DKASC_Yulara/raw_info'), 
