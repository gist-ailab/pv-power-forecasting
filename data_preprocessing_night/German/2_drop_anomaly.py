...
if __name__ == '__main__':
    ...
    save_dir = os.path.join(project_root, 'data/Germany_Household_Data/processed_data')
    os.makedirs(save_dir, exist_ok=True)
    
    hourly_csv_data_dir = os.path.join(project_root, 'data/Germany_Household_Data/uniform_format_data')  # for local
    ...
    log_file_path=os.path.join(project_root, 'data_preprocessing_night/German/processed_info/processed_data_info.txt')
    )
    plot_correlation_each.plot_feature_vs_active_power(
            data_dir=save_dir, 
            save_dir=os.path.join(project_root, 'data_preprocessing_night/German/processed_info'), 
