...
if __name__ == '__main__':
    ...
    save_dir = os.path.join(project_root, 'data/OEDI/9069(Georgia)/processed_data')
    ...
    aggregated_output_path = os.path.join(project_root, 'data/OEDI/9069(Georgia)/processed_data/aggregated_average_data.csv')
