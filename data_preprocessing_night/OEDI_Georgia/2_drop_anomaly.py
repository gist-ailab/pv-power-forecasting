...
if __name__ == '__main__':
    ...
    save_dir = os.path.join(project_root, 'data/OEDI/9069(Georgia)/processed_data_invertor')
    os.makedirs(save_dir, exist_ok=True)
    
    hourly_csv_data_dir = os.path.join(project_root, 'data/OEDI/9069(Georgia)/uniform_format_data')  # for local
    ...
    aggregated_output_path = os.path.join(project_root, 'data/OEDI/9069(Georgia)/processed_data/aggregated_data.csv')
    ...
    folder_path=os.path.join(project_root, 'data/OEDI/9069(Georgia)/processed_data'),
    log_file_path=os.path.join(project_root, 'data_preprocessing_night/OEDI_Georgia/processed_info/processed_data_info.txt')
    )
    plot_correlation_each.plot_feature_vs_active_power(
            data_dir=os.path.join(project_root, 'data/OEDI/9069(Georgia)/processed_data'), 
            save_dir=os.path.join(project_root, 'data_preprocessing_night/OEDI_Georgia/processed_info'), 
