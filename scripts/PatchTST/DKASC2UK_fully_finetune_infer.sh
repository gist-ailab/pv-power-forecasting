...
do
    python -u run_longExp.py \
      ...
      --is_inference 1 \
      --checkpoints  /home/seongho_bak/Projects/PatchTST/checkpoints/fully_finetune/fully_finetune_24110113_PatchTST_UK_ftMS_sl512_ll0_pl16_dm128_nh16_el5_dl1_df1024_fc1_ebtimeF_dtTrue_Exp_0/checkpoint.pth\
