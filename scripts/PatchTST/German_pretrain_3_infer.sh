...
model_name=PatchTST
model_id=$DATE
exp_id="${DATE}_Pretrain_German_Source_$model_name"_individual
...
do
    python -u run_longExp.py \
        ...
        --is_inference 1 \
        --checkpoints ./checkpoints/24112702_Pretrain_DKASC_Source_night_PatchTST_individual/checkpoint.pth \
