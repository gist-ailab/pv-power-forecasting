...
do
    python -u run_longExp.py \
        ...
        --is_inference 1 \
        --checkpoints /home/seongho_bak/Projects/PatchTST/checkpoints/24112516_PatchTST_['GIST']_ftMS_sl256_ll0_pl16_dm256_nh8_el4_dl1_df512_fc1_ebtimeF_dtTrue_Exp_0/checkpoint.pth\
