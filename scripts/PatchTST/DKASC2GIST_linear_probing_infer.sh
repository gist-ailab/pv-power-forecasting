...
do
    python -u run_longExp.py \
      ...
      --is_pretraining 0 \
      --is_inference 1 \
      --checkpoints /home/seongho_bak/Projects/PatchTST/checkpoints/linear_probe/linear_probe_24110407_PatchTST_GIST_ftMS_sl256_ll0_pl16_dm256_nh8_el4_dl1_df512_fc1_ebtimeF_dtTrue_Exp_0/checkpoint.pth\
