...
model_name=PatchTST
model_id=$DATE
exp_id="${DATE}_Pretrain_Miryang_standard_infer_$model_name"
...
do
    python -u run_longExp.py \
      ...
      --is_pretraining 1 \
      --is_inference 1 \
      --checkpoints /home/seongho_bak/Projects/PatchTST/checkpoints/24110419_PatchTST_Miryang_Standard_ftMS_sl256_ll0_pl16_dm256_nh8_el4_dl1_df512_fc1_ebtimeF_dtTrue_Exp_standard_0/checkpoint.pth\
