...
model_name=PatchTST
model_id=$DATE
exp_id="${DATE}_Fully_Finetune_2_DKASC2Miryang_$model_name"
...
for i in "${!pred_len[@]}"; do
    ...
    python -u run_longExp.py \
      ...
      --patience 20\
      --embed 'timeF' \
      --itr 1 --batch_size 1024 --learning_rate 0.00001 >logs/$exp_id/$model_name'_'$data_name'_'$seq_len'_'$pl.log
done