...
model_name=PatchTST
model_id=$DATE
exp_id="${DATE}_Linear_probing0.001_DKASC2GIST_$model_name"
...
for i in "${!pred_len[@]}"; do
    ...
    python -u run_longExp.py \
      ...
      --patience 20\
      --embed 'timeF' \
      --itr 1 --batch_size 1024 --learning_rate 0.001 >logs/$exp_id/$model_name'_'$data_name'_'$seq_len'_'$pred_len'_'$e_layers'0.001.log'
done