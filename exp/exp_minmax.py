        ...
        with torch.no_grad():
            for i, data in enumerate(vali_loader):
                ...
                if self.args.model != 'LSTM':
                    ...
                    # print(site)
                    active_power_np = vali_data.inverse_transform(site, output_np.copy())
                    active_power_gt_np = vali_data.inverse_transform(site, batch_y_np.copy())
        ...
        with torch.no_grad():
            ...
            for i, data in enumerate(test_loader):
                ...
                if self.args.model != 'LSTM':
                    ...
                    pred = test_data.inverse_transform(site, outputs_np.copy())
                    true = test_data.inverse_transform(site, batch_y_np.copy())
