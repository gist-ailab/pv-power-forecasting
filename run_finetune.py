...
if __name__ == '__main__':
    ...
    # basic config
    parser.add_argument('--is_training', type=int, default=0, help='do finetuning or not')
    parser.add_argument('--is_fully_finetune', type=int, default=0)
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            if args.is_fully_finetune:
                exp.fully_finetune(setting, args.exp_id, args.resume)
