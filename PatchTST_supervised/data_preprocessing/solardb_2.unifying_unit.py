...
if __name__ == '__main__':
    root_path = 'dataset/SolarDB/raw'
    # info = 'pre-process'
    info = 'kW_allWeather'
    save_path = f'dataset/SolarDB/{info}'
    ...
    for i in range(1, 17):
        ...
        power['power_ac'] /= 1000       ## change W to kW
        # print(meta['location'][0])
        # print(power['dt'].head())
        # print(power['dt'].tail())

        # _columns = ['timestamp', 'power_ac', 'temp', 'humidity', 'sun_irradiance']
        _columns = ['timestamp', 'power_ac']
        _columns.extend(weather.columns.tolist()[5:-2])
        ...
        while True:
            ...
            for hour in range(0, 24):
                ...
                new_row.extend(weather.loc[weather_first_idx:weather_last_idx, weather.columns.tolist()[5:-2]].mean().tolist())
